...
The .vdt data can be standardised in the same format as the output of `prep_data()` using `prep_vdt_dat()`. Note, all later functions rely on the output format of these two functions.

```{r}

demos_001_vdt <- prep_vdt_dat(
